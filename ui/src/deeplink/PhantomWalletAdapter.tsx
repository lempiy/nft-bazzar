...
import { PhantomDLWallet } from './PhantomWallet';

export interface PhantomWalletAdapterConfig {
    wallet: PhantomDLWallet;
}

export const PhantomWalletName = 'Phantom Mobile' as WalletName<'Phantom Mobile'>;
...
export class PhantomDeepLinkWalletAdapter extends BaseMessageSignerWalletAdapter {
    ...
    private _wallet: PhantomDLWallet;
